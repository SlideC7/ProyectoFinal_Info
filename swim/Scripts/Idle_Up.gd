...
func _process(delta):
	...
	if sensor==1 and Input.is_action_just_pressed("ui_up"):
			#anim.play("Good")
...
func _on_Idle_Up_area_shape_entered(area_rid, area, area_shape_index, local_shape_index):
...
func _on_Idle_Up_area_shape_exited(area_rid, area, area_shape_index, local_shape_index):
	sensor=0
	Global.sensor_AU=0
